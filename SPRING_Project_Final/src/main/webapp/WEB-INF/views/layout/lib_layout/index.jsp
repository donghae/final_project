...
<!-- 
		...
		<div class="container">
			...
			<div class="row course_boxes">
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						<img class="card-img-top" src="resources/images/course_1.jpg" alt="https://unsplash.com/@kellybrito">
						...
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
								<img src="resources/images/common_img/icons/author.jpg" alt="https://unsplash.com/@mehdizadeh">
							</div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						<img class="card-img-top" src="resources/images/course_2.jpg" alt="https://unsplash.com/@cikstefan">
						<div class="card-body text-center">
			...
			<div class="row services_row">
				...
				<div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
					<div class="icon_container d-flex flex-column justify-content-end">
						<img src="resources/images/common_img/icons/earth-globe.svg" alt="">
					</div>
				...
				<div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
					<div class="icon_container d-flex flex-column justify-content-end">
						<img src="resources/images/common_img/icons/exam.svg" alt="">
					</div>
				...
				<div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
					<div class="icon_container d-flex flex-column justify-content-end">
						<img src="resources/images/common_img/icons/books.svg" alt="">
					</div>
				...
				<div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
					<div class="icon_container d-flex flex-column justify-content-end">
						<img src="resources/images/common_img/icons/professor.svg" alt="">
					</div>
				...
				<div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
					<div class="icon_container d-flex flex-column justify-content-end">
						<img src="resources/images/common_img/icons/blackboard.svg" alt="">
					</div>
					<h3>Top Programs</h3>
					<p>In aliquam, augue a gravida rutrum, ante nisl fermentum nulla, vitae tempor nisl ligula vel nunc. Proin quis mi malesuada, finibus tortor fermentum.</p>
				</div>
				...
				<div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
					<div class="icon_container d-flex flex-column justify-content-end">
						<img src="resources/images/common_img/icons/mortarboard.svg" alt="">
					</div>
	...
	<div class="testimonials page_section">
		<div class="testimonials_background" style="background-image:url(resources/images/testimonials_background.jpg)"></div>
		<div class="testimonials_background_container prlx_parent">
			<div class="testimonials_background prlx" style="background-image:url(resources/images/testimonials_background.jpg)"></div>
		</div>
		<div class="container">
								...
								<div class="testimonials_item text-center">
									...
									<div class="testimonial_user">
										<div class="testimonial_image mx-auto">
											<img src="resources/images/common_img/icons/testimonials_user.jpg" alt="">
										</div>
						...
						<div class="row d-flex flex-row align-items-end">
							...
							<div class="col-lg-4 order-lg-3 order-1">
								<div class="event_image">
									<img src="resources/images/common_img/icons/event_1.jpg" alt="https://unsplash.com/@theunsteady5">
								</div>
							</div>
				...
				<div class="row event_item">
					<div class="col">
						<div class="row d-flex flex-row align-items-end">
							...
							<div class="col-lg-4 order-lg-3 order-1">
								<div class="event_image">
									<img src="resources/images/common_img/icons/event_2.jpg" alt="https://unsplash.com/@claybanks1989">
								</div>
							</div>
				...
				<div class="row event_item">
					<div class="col">
						<div class="row d-flex flex-row align-items-end">
							...
							<div class="col-lg-4 order-lg-3 order-1">
								<div class="event_image">
									<img src="resources/images/common_img/icons/event_3.jpg" alt="https://unsplash.com/@juanmramosjr">
								</div>
							</div>
