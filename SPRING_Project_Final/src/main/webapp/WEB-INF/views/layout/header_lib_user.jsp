					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li class="has-dropdown active">
								<a href="#">도서 관리</a>
								<ul class="dropdown">
									<li><a href="lib_rental">도서 등록</a></li>
									<li><a href="lib_rental">도서 현황</a></li>
									<li><a href="lib_reservation">도서 대출납</a></li>																		
								</ul>
							</li>		
							<li class="has-dropdown active">
								<a href="#">희망도서 관리</a>
								<ul class="dropdown">
									<li><a href="lib_rental">신청 내역</a></li>
									<li><a href="lib_rental">승인 내역</a></li>																
								</ul>
							</li>													
						</ul>
					</div>
