...
<link rel="stylesheet" href="resources/css/footer_ara.css"> <!-- 외부스타일시트 -->
...
<!-- 푸터	 --> 			 
	...
	<div style="background-color:#001E42;color:#ffffff;">
		...
		<div>
			...
			<div id="div_c"><h3 class="h0">사회 대학</h3>
			<ul>
				<li>
					<a href="" 
					onclick="javascript:window.open
			...
			<div id="div_1">
				...
				<hr>
				<p style="color:white;">주소:서울특별시 금천구 가산디지털2로 123</p>
			</div>
			<div class="button">
				<button class="myButton">기숙사</button>
				<button class="myButton">도서관</button>
				</div>
			</div>	
			<div id="div_0">
			<div id="div_d"><h3 class="h0">예술 대학</h3>
				<ul>
					<li>
						<a href="" 
						onclick="javascript:window.open
					...
					<li>
						...
						onclick="javascript:window.open
						('http://ipsi.dankook.ac.kr/pop/movie_pop42.php','','width=580,height=450,top=0,left=0,scrollbars=yes');" 
						title="새창으로 열림">문예창작</a>
					</li>
					<li>
						<a href="" 
						onclick="javascript:window.open
						('http://ipsi.dankook.ac.kr/pop/movie_pop46.php','','width=580,height=450,top=0,left=0,scrollbars=yes');" 
						title="새창으로 열림">실용음악</a>
					</li>
					<li>
						<a href="" 
						onclick="javascript:window.open
			...
			<div id="div_3">
				<a href="https://ko-kr.facebook.com/"><img id="img1" src="resources/images/sns_img/facebook.png"></a>
				<a href="https://www.instagram.com/?hl=ko"><img id="img1" src="resources/images/sns_img/insta.png"></a>
				<a href="https://twitter.com/?lang=ko"><img id="img1" src="resources/images/sns_img/twitter.PNG"></a>
				<a href="https://www.youtube.com/?gl=KR&hl=ko"><img id="img1" src="resources/images/sns_img/youtube.PNG"></a>
			</div>
			</div>
			</div>		
		</div>
