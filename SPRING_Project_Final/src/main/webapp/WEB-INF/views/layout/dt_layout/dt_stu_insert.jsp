...
<div class="container" style="margin-left:550px;">
    ...
    <div class="col-md-8">
      <section>      
        ...
        <hr>
            <form class="form-horizontal" method="post" name="signup" id="signup" enctype="multipart/form-data" action="admin_stu_insert">        
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
              <input type="text" class="form-control" name="dorm_penalty" id="cpassword" placeholder="벌점을 입력해 주세요" value="">
            </div>  
          </div>
        </div>
 
         <div class="form-group">
          <label class="control-label col-sm-3">외박점수<span class="text-danger">*</span></label>
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
              <input type="text" class="form-control" name="dorm_overnight" id="cpassword" placeholder="외박점수를 입력해 주세요" value="">
            </div>  
          </div>
        </div>          
