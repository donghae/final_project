...
<div class="container" >
   ...
   <h1 class="entry-title" style="text-align: center;"><span style="font-size:x-large; color:#48FFFF; " >외 박 신 청<br></span> </h1>
      ...
      <section>      
        <hr>
            <form class="form-horizontal" method="post" name="signup" id="signup" enctype="multipart/form-data" action="dt_stu_overnight_insert">        
        ...
        <div class="form-group" style="margin-left: 5px;">
          ...
          <div class="col-xs-8">
            <div class="form-inline">
              <div class="form-group">
                <select name="overnight_dd" class="form-control" style=" height:35px;">
              ...
              <div class="form-group">
                <select name="overnight_mm" class="form-control" style=" height:35px;">
                  <option value="">Month</option>
                  <option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option>                </select>
              </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <div class="form-group" >
                <select name="overnight_yy" class="form-control" style=" height:35px;">
