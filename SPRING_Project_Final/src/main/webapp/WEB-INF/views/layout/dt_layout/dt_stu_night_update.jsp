...
<%-- <%   			
 			String dorm_date = dto.dorm_ex_date;
			String yyyy = dorm_date.split("-")[0];
			String mm = dorm_date.split("-")[1];           	
		    String dd = dorm_date.split("-")[2];
%> --%>          	          	
<!--               <div class="form-inline">
	...
	<c:forEach var="dto" items="${dtos}">
		...
		<div class="container">
			<div class="row">
		&nbsp;<textarea  id="paste" name="textarea" value="${dto.dorm_reason}"></textarea>
			</div>
		</div>
	</c:forEach>
        <div class="form-group">
