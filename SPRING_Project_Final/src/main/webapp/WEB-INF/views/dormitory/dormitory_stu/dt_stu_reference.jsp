                            ...
                            <div class="collapse navbar-collapse" id="studioMenu">
                                ...
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="dormitory_reference" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">기숙사생 관리</a>
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="dormitory_reference">기숙사생 학생정보</a>
                                        </div>
                                        
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">기숙사 월별 식단표</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <!-- <li class="nav-item"> -->
                                    <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">외박관리</a>
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="#">조회</a>
                                            <a class="dropdown-item" href="#">신청</a>
            ...
            <div class="carousel-inner h-100">						   <!-- 투명도 -->
                <div class="carousel-item h-100 bg-img active" style= "hheight:200px;  /* opacity:0.5; */  background-image: url(resources/images/common_img/UNI/dormitory.jpg);">
 	               	<div style="padding-top: 200px;">
 	               		<%@ include file="../../layout/dt_layout/search2.jsp" %>
	               		</div> 
	                </div>     
