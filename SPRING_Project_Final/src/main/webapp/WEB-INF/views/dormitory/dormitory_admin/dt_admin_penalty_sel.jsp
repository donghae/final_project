    ...
    <section class="welcome-area">
        <div class="carousel h-100 slide" data-ride="carousel" id="welcomeSlider">
            ...
            <div class="carousel-inner h-100">						   
                <div class="carousel-item h-100 bg-img active" style= "height:200px;  /* opacity:0.5; */  background-image: url(resources/images/common_img/UNI/dormitory.jpg); padding:0px;">
               		<div style="padding-top: 100px;">
               			<div style="height:200px;">
               				<%-- <%@ include file="../../layout/dt_layout/dt_stu_penalty_sel.jsp" %> --%>
               			</div>
 						<h3>벌점 조회</h3>
 						<div class="container">
						    <div class="row">
						      <div class="table-responsive" style="float: left;">
						        <table class="table table-hover" style="height:30px;">
						          <thead>
						            <tr>
						              <th>학번</th>
						              <th>이름</th>
						          ...
						          <tbody id="myTable">
						          <c:if test="${dto.dorm_penalty != null}">
						            <tr>
						              <td>${dto.st_no}</td>
						              <td>${dto.st_name}</td>
						              <td>${dto.dorm_room}</td>
