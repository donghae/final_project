            ...
            <div class="carousel-inner h-100">						   <!-- 투명도 -->
                <div class="carousel-item h-100 bg-img active" style= "hheight:200px;  /* opacity:0.5; */  background-image: url(resources/images/common_img/UNI/dormitory.jpg);">
                	<div style="padding-top: 100px;">
               			...
               			<%@ include file="../dt_layout/dt_stu_form.jsp" %> --%>
               			<%@ include file="../../layout/dt_layout/dt_admin_notice_box.jsp" %>
               		</div>                                
                	
                	<div style="margin-top:70px;">
                		<div class="container">
							<div class="row">     
						        <form class="classNameHere" role="search" action="dt_admin_notice_modify2">
						    	<div class="input-group">
									<input type="text" class="form-control" placeholder="관리자 번호를 입력해 주세요." name="ad_no" id="srch">
