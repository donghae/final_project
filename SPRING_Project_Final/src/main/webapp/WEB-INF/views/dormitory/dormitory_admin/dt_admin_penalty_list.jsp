    ...
    <section class="welcome-area">
        <div class="carousel h-100 slide" data-ride="carousel" id="welcomeSlider">
            ...
            <div class="carousel-inner h-100" >						   <!-- 투명도 -->
                <div class="carousel-item h-100 bg-img active" style= "height:300px;  /* opacity:0.5; */  background-image: url(resources/images/common_img/UNI/dormitory.jpg); padding:0px;">
						      ...
						      <div class="table-responsive" style="height:300px;">
						        <table class="table table-hover">
						          ...
						          <tbody id="myTable">
						            <tr>
						              <td>${dto.st_no}</td>
						              <td><a href="admin_penalty_upd?st_no=${dto.st_no}&dorm_reason=${dto.dorm_reason}">${dto.st_name}</a></td>						            
