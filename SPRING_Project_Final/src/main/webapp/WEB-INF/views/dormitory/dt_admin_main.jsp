...
<body>
                                ...
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="dt_stu_ins">학생등록</a>
                                            <a class="dropdown-item" href="dt_facilities">기숙사 시설</a>
                                            <a class="dropdown-item" href="dt_place">오시는 길</a>
                                        </div>
                                    </li>
                                    <!-- <li class="nav-item"> -->
                                    <li class="nav-item dropdown">
  ...
  <div class="wrapper" >
        ...
        <table id="acrylic" style="width:1300px; height:700px; margin-top:0px; margin-left:-600px;">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Age</th>
