				...
				<div class="inbox-body">	
					...
					<form action="inputGradePro" name="inputGradeForm">
						...
						<tbody>
							...
							<tr>
								<td><input type="text" name="attend" size="5"></td>
								<td><input type="text" name="midterm" size="5"></td>
								<td><input type="text" name="finalterm" size="5"></td>
								<td><input type="text" name="attitude" size="5"></td>
							</tr>			
						</tbody>
