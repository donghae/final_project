			...
			<div class="mail-box">
				...
				<div class="inbox-body">
					<div class="mail-option">
						<table class="st_mint" style="width: 1300px; margin-left: 0px; margin-right: 0px;" align="center">
							<tr>
								<th>
							...
							<c:if test="${cnt>0}">
								<c:forEach var="dto" items="${dtos}">
									...
									<tr>
										<td style="text-align: center"><input class="btn_navy" type="button" value="추가"></td>
