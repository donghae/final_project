...
/*		String yyyy = dorm_ex_date;
	...
	public void updateDormNotice(HttpServletRequest req, Model model) {
		...
		Admin_notice_selectVO dto = dao.updateDormNotice(dorm_n_no);
	...
	public void updateDormNoticeCon(HttpServletRequest req, Model model) {		
		...
		String ad_no = req.getParameter("dh");
		String dorm_n_title = req.getParameter("notice_title");
		String dorm_n_content = req.getParameter("notice_content");
		String dorm_n_dt = req.getParameter("notice_dt");
		String dorm_n_file = req.getParameter("notice_file");
		...
		System.out.println(dorm_n_file);		
		...
		map.put("ad_no", ad_no);
		map.put("dorm_n_file", dorm_n_file);
	...
	public void addDormNotice(HttpServletRequest req, Model model) {
		...
		dto.setDorm_n_title(req.getParameter("title"));
		dto.setDorm_n_content(req.getParameter("content"));
		dto.setDorm_n_file(req.getParameter("file"));
...
/*	// 관리자 공지사항 수정 목록 뿌리기
	...
	public void addAdminNoticeModify(HttpServletRequest req, Model model) {
		int ad_no = Integer.parseInt(req.getParameter("ad_no"));
		
		Admin_notice_selectVO dto = dao.addAdminNoticeModify(ad_no);
