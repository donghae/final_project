...
public class Attend_Lec_VO {
	...
	private String lec_startDate; // 강의시작일

	public String getLec_startDate() {
		return lec_startDate;
	}

	public void setLec_startDate(String lec_startDate) {
		this.lec_startDate = lec_startDate;
	}
