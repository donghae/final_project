...
public class Lec_Prof_VO {

	private String prof_no; // 교수번호
	private int maj_cd; // 전공명
	private String prof_pwd; // 비밀번호
	private String prof_hp; // 전화번호
	private String prof_name; // 교수이름
	private String prof_zipcode; // 교수 우편번호
	private String prof_addr1; // 교수 주소1
	private String prof_addr2; // 교수 주소2
