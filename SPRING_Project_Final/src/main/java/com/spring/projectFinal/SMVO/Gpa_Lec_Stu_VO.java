...
// 성적 + 강의 + 학생 테이블
public class Gpa_Lec_Stu_VO {

	private String st_no; // 학번(FK)
	...
	private String cc_name; // 동아리명(FK)
	...
	public Date getSt_birth() {
		return st_birth;
	}

	public void setSt_birth(Date st_birth) {
