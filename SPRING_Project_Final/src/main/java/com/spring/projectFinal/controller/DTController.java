...
public class DTController {
	 ...
	 * // 학생 기숙사 홈
	 * 
	 * @RequestMapping("dormitory") public String dormitory(HttpServletRequest
	 * req,Model model) {
	 * 
	 * System.out.println("dormitory-기숙사 홈");
	 * 
	...
	// 학생 공지사항 상세 조회
	/*
	 * @RequestMapping("dt_stu_notice_sel") public String
	 * dt_stu_notice_sel(HttpServletRequest req,Model model) {
	 * System.out.println("dt_stu_notice_sel-학생 공지사항 조회");
	 * 
	 * service.dtStuNotice(req,model);
	 * 
	 ...
	 * // 관리자 기숙사 홈
	 * 
	 * @RequestMapping("admin") public String admin(HttpServletRequest req,Model
	 * model) {
	 * 
